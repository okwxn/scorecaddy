...
- The USGA/World Handicap System (WHS) formula is: $$\text{Course Handicap} = \text{Handicap Index} \times \left(\frac{\text{Slope Rating}}{113}\right) + (\text{Course Rating} - \text{Par})$$
